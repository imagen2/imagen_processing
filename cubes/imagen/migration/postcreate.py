...
with open(_LDAP_CONFIGURATION_FILE) as configuration_file:
    ...
    _LDAP_CONFIGURATION_DETAILS = {
        ...
        'user-base-dn': configuration['user-base-dn'],
        'user-attrs-map': configuration['user-attrs-map'],
        'group-base-dn': configuration['group-base-dn'],
        'group-attrs-map': configuration['group-attrs-map'],
    }
